...
$logRoot = Join-Path $projectRoot "outputs\compile\objective_m15_m5_setup_adapter"
$target = "tests\TestObjectiveMultiTimeframeSetupAdapter.mq5"

& (Join-Path $PSScriptRoot "sync_objective_m15_m5_setup_adapter_to_mt5.ps1") `
...
$log = Join-Path $logRoot "TestObjectiveMultiTimeframeSetupAdapter.log"
...
Write-Output "Objective M15/M5 Setup adapter compile passed: 1/1 target, 0 errors, 0 warnings."
