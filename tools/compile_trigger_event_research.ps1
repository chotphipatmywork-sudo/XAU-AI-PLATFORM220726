...
$logRoot = Join-Path $projectRoot "outputs\compile\trigger_event"
$relativeFile = "tests\TestPastOnlyTriggerEventExporter.mq5"

& (Join-Path $PSScriptRoot "sync_trigger_event_research_to_mt5.ps1") `
...
$log = Join-Path $logRoot "TestPastOnlyTriggerEventExporter.log"
...
Write-Output "Trigger-event research compile passed: 1/1 target, 0 errors, 0 warnings."
